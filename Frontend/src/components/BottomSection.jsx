...
const ImageSection = (props) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col items-center justify-center text-center py-4 px-4 gap-3 sm:w-1/2 sm:px-4 md:px-12 md:gap-6 lg:px-20">
          <h1 className="font-heading text-4xl text-primary md:text-5xl lg:text-6xl">
            {t("Cupcake Perfection: Love-Baked by Terrific Bites")}
          </h1>
          <p className={`font-body text-sm text-gray lg:text-base ${lang === "ar" && "text-lg lg:text-2xl"}`}>
            {t(
